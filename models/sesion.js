...
const SesionSchema = Joi.object({
  ...
  codigoModulo: Joi.string().max(200).allow('', null).optional().default('TAB_PLAT_PRINCIPAL'),
  nombreUsuario: Joi.string().max(100).required(),
  rol: Joi.string().max(100).allow('', null).optional().default('ROLE_USUARIO'),
...
const SesionDTO = (rawData) => {
  ...
  return {
    ...
    codigoModulo: value.codigoModulo ? value.codigoModulo.trim() : '19dbd560-5ace-4386-865a-17605dd9bca4',
...
const SesionModel = (sequelize) => {
  return sequelize.define('PTLSesiones', {
    ...
    codigoModulo: { type: DataTypes.STRING(200), allowNull: true, defaultValue: '19dbd560-5ace-4386-865a-17605dd9bca4' },
